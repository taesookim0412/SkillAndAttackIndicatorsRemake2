...
namespace DTT.AreaOfEffectRegions
{
    ...
    public class SRPLineRegionProjector : MonoBehaviour
    {
        ...
        public void SetTerrainLayer(int terrainRenderingLayer)
        {
            _headProjector.renderingLayerMask = (uint) terrainRenderingLayer;
            _bodyProjector.renderingLayerMask = (uint) terrainRenderingLayer;
        }
